...
class CqCqbnGovCnSpider(scrapy.Spider):
    name = 'cq_cqbn_gov_cn'
    allowed_domains = ['cqbn.gov.cn']
    start_urls = ['http://www.cqbn.gov.cn/zwxx_252/qxdt/']
    city = '500000'
    area = '500113'
    suid = 67115
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[@class="center-list"]/li').getall()
