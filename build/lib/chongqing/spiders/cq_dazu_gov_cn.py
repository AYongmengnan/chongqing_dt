...
class CqDazuGovCnSpider(scrapy.Spider):
    name = 'cq_dazu_gov_cn'
    allowed_domains = ['dazu.gov.cn']
    start_urls = ['http://www.dazu.gov.cn/zwxx_175/qxdt/']
    city = '500000'
    area = '500225'
    suid = 67131
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[@class="dzgl-list"]/li').getall()
