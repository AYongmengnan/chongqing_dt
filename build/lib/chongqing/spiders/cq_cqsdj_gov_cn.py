...
class CqCqsdjGovCnSpider(scrapy.Spider):
    name = 'cq_cqsdj_gov_cn'
    allowed_domains = ['cqsdj.gov.cn']
    start_urls = ['http://www.cqsdj.gov.cn/sy/djdt/xlddt/']
    city = '500000'
    area = '500231'
    suid = 67155
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[contains(@class,"right-list")]/li').getall()
