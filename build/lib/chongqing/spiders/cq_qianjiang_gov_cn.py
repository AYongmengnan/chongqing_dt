...
class CqQianjiangGovCnSpider(scrapy.Spider):
    name = 'cq_qianjiang_gov_cn'
    allowed_domains = ['qianjiang.gov.cn']
    start_urls = ['http://www.qianjiang.gov.cn/zwxx_210/qjdt/']
    city = '500000'
    area = '500114'
    suid = 67098
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[@class="fr-main"]/li').getall()
