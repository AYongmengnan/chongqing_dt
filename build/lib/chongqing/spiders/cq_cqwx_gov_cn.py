...
class CqCqwxGovCnSpider(scrapy.Spider):
    name = 'cq_cqwx_gov_cn'
    allowed_domains = ['cqwx.gov.cn']
    start_urls = ['http://www.cqwx.gov.cn/zwxx_224/qxdt/']
    city = '500000'
    area = '500238'
    suid = 67162
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//div[@class="infolists"]/ul/li').getall()
