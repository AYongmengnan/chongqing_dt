...
class CqCqyzGovCnSpider(scrapy.Spider):
    name = 'cq_cqyz_gov_cn'
    allowed_domains = ['cqyz.gov.cn']
    start_urls = ['http://www.cqyz.gov.cn/zwxx_229/yzyw/']
    city = '500000'
    area = '500103'
    suid = 67102
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[@class="de-ul-font"]/li').getall()
