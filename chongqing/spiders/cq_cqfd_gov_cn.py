...
class CqCqfdGovCnSpider(scrapy.Spider):
    name = 'cq_cqfd_gov_cn'
    allowed_domains = ['cqfd.gov.cn']
    # start_urls = ['http://www.cqfd.gov.cn/sy_200/szyw/']
    start_urls = ['http://www.cqfd.gov.cn/sy_200/szyw1/']
    city = '500000'
    area = '500230'
    suid = 67151
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//div[@class="hover-blue"]/ul/li').getall()
