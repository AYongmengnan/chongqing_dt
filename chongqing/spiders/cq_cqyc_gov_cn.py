...
class ZhongxianGovCnSpider(scrapy.Spider):
    name = 'cq_cqyc_gov_cn'
    allowed_domains = ['cqyc.gov.cn']
    start_urls = ['http://www.cqyc.gov.cn/sy_204/qxdt/']
    city = '500000'
    area = '500383'
    suid = 67126
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[@class="right-list"]/li').getall()
