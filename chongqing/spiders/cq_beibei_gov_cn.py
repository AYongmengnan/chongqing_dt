...
class CqBeibeiGovCnSpider(scrapy.Spider):
    name = 'cq_beibei_gov_cn'
    allowed_domains = ['beibei.gov.cn']
    start_urls = ['http://www.beibei.gov.cn/zwxx_239/gzdt/bbxw/']
    city = '500000'
    area = '500109'
    suid = 67118
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//div[@class="infolist"]/ul/li').getall()
    ...
    def parse_content(self, response):
        ...
        try:
            ...
            title = Selector(text=li_tag).xpath('//a/text()').extract_first()
