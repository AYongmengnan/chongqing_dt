...
class CqFlGovCnSpider(scrapy.Spider):
    name = 'cq_fl_gov_cn'
    allowed_domains = ['fl.gov.cn']
    start_urls = ['http://www.fl.gov.cn/zwxx_206/ywdt/']
    city = '500000'
    area = '500102'
    suid = 67101
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//div[@class="infos-box"]/ul/li').getall()
    ...
    def parse_content(self, response):
        ...
        try:
            ...
            time_text = Selector(text=li_tag).xpath('//span[1]/text()').extract_first()
