...
class CqCqstlGovCnSpider(scrapy.Spider):
    name = 'cq_cqstl_gov_cn'
    allowed_domains = ['cqstl.gov.cn']
    start_urls = ['https://www.cqstl.gov.cn/zwxx_171/tlyw/']
    city = '500000'
    area = '500224'
    suid = 67133
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//div[@class="news_list"]/ul/li').getall()
