...
class CqDdkGovCnSpider(scrapy.Spider):
    name = 'cq_ddk_gov_cn'
    allowed_domains = ['ddk.gov.cn']
    start_urls = ['http://www.ddk.gov.cn/zwxx_271/qxdt/']
    city = '500000'
    area = '500104'
    suid = 67105
    spider_status = {}
    ...
    def parse(self, response):
        ...
        li_list = response.xpath('//ul[@class="r-list-16"]/li').getall()
